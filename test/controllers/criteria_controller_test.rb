...
class CriteriaControllerTest < ActionController::TestCase
  ...
  test "should create criterium" do
    assert_difference('Criterium.count') do
      post :create, criterium: { customer_name: @criterium.customer_name, responder_email: @criterium.responder_email, responder_name: @criterium.responder_name, response_type: @criterium.response_type }
    end
  ...
  test "should update criterium" do
    patch :update, id: @criterium, criterium: { customer_name: @criterium.customer_name, responder_email: @criterium.responder_email, responder_name: @criterium.responder_name, response_type: @criterium.response_type }
    assert_redirected_to criterium_path(assigns(:criterium))
  end
