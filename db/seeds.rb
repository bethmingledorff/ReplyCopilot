Response.create!([
  ...
  },
  {
  	...
  	line3: ["but it looks like we dropped the ball this time. ", "but in this case, we blew it! ", "but sometimes we do not succeed in 100% customer satisfaction. ", "but mistakes were made. "],
  	line4: ["Your satisfaction is our priority and we'd like to follow up with you directly. Please contact me directly at ", "Please allow us the opportunity to win back your business. You can email me directly at "],
  	line5: ["We want to resolve this issue to your satisfaction. ", "We'll do our best to make it right. "],
  	line6: ["I look forward to hearing from you. ", "I hope to hear from you soon. "],
  	close: ["Sincerely,", "Speak soon,", "Speak soon,"],
  	intro: ["Hello", "Thank you for getting in touch", "We appreciate you reaching out", "I'm glad you wrote"]
  },
  {
  	name: "FYG Neutral",
  	line1: ["It doesn't sound like we 'wow'd' you, so please help us up our game. ", "Your feedback helps us improve our service. ", "It sounds like our service was satisfactory, but we strive to do better than that. "],
  	line2: ["Be sure to let us know what else we can do to improve. ", "Your suggestions are welcome. "],
  	line3: ["You can reach me directly at ", "Please contact me directly at "],
  	line4: ["to share any further comments. ", "so we can turn that 'meh' into a 'wow'. "],
  	line5: [],
  	line6: [], 
  ...
  },
  {
  	...
  	intro: ["Oh dear! ", "Dangit! ", "Sorry to hear! "],
  	line1: ["Let's fix it! ", "Help us improve! ", "Let's make it right! "],
  	line2: ["Please email me at ", "Please contact me at "],
  	close: ["Best,", "Thanks"]
  },
  {
  	name: "Twitter Neutral",
  	intro: ["Thanks for the feedback. ", "Thanks for sharing. "],
  	line1: ["It's important to us. ", "We value your comments. "],
  	line2: ["It helps us up our game. ", "It help us improve our service. "],
  ...
  {
  	name: "Trip Advisor Negative",
  	intro: ["Oh dear! ", "Dangit! ",
  	"Sorry to hear! "],
  	line1: ["Let's fix it! ", "Help us improve! ", "Let's make it right. "],
  	line2: ["Please email me at ", "Please contact me at "],
  	close: ["Best,",  "Thanks,"]
  ...
  {
  	name: "Trip Advisor Neutral",
  	intro: ["Thanks for the comments, ", "Thanks for sharing, "],
  	line1: ["It's important to us. ", "We value your feedback. "],
  	line2: ["It helps us up our game. ", "It help us improve our service. "],
  	close: ["Thank you!"]
  }
])
