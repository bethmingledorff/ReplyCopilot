...
#testing ajax stuff
  ...
  def create
    ...
    respond_to do |format|
      if @criterium.save
        format.html { redirect_to @criterium }
  ...
  private
    ...
    def criterium_params
      params.require(:criterium).permit(:customer_name, :response_type, :responder_name, :responder_email)
    end
end
